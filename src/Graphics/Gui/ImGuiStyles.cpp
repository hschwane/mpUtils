...
void StyleDarcula()
{
    ...
    *style = ImGuiStyle();
    ...
    colors[ImGuiCol_WindowBg]               = ImVec4(0.22f, 0.23f, 0.23f, 0.94f);
    colors[ImGuiCol_ChildBg]                = ImVec4(0.22f, 0.23f, 0.23f, 0.00f);
    colors[ImGuiCol_PopupBg]                = ImVec4(0.22f, 0.23f, 0.23f, 0.94f);
    ...
    colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.12f, 0.12f, 0.12f, 0.90f);
    colors[ImGuiCol_MenuBarBg]              = ImVec4(0.27f, 0.29f, 0.29f, 0.80f);
    colors[ImGuiCol_ScrollbarBg]            = ImVec4(0.27f, 0.29f, 0.29f, 0.60f);
    colors[ImGuiCol_ScrollbarGrab]          = ImVec4(0.22f, 0.31f, 0.42f, 0.78f);
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.26f, 0.38f, 0.51f, 1.00f);
    ...
    colors[ImGuiCol_Header]                 = ImVec4(0.34f, 0.36f, 0.37f, 0.71f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.31f, 0.47f, 0.70f, 0.71f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.47f, 0.47f, 0.47f, 0.71f);
