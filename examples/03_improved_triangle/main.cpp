...
int main()
{
    ...
    // setup the shader
    gph::ShaderProgram colorShader({{PROJECT_SHADER_PATH"minimalColorVS.vert"},{PROJECT_SHADER_PATH"minimalColorFS.frag"}});
    float maxDensity = 10;
    colorShader.uniform1f("maxDensity",maxDensity);
