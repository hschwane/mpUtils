...
/**
 * @brief Parses command line argument into a object of "OptionStruct" See ArgParser::parse for full documentation.
 * @tparam OptionStruct Arguments will be parsed into a object of this type.
 * @tparam allowPositional If true, a vector of positional arguments will be appended to OptionStruct.
 */
