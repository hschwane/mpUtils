...
public:
     ...
     * @param forward forward direction, 0 means to the right pi to the left
     */
    Sprite2D(const std::string& imageFile, glm::vec2 size={1,1}, float forward=0);
     ...
     * @param forward forward direction, 0 means to the right pi to the left
     */
    Sprite2D(const unsigned char * data, int length, glm::vec2 size={1,1}, float forward=0);
